    ...
    <div class="col-lg-12">
        <div class="ui container pt-3">
            <div class="ui info message">
                ...
                <button onclick="location.href ='notice_data.php';" class="ui mini primary button"> <i class="fas fa-database"></i> Data Table </button>
        ...
        <form action="code.php" method="POST" style="margin-top:3rem">
            ...
            <input type="submit" name="notice_submit" class="positive ui button mt-2" value="Update News">
        </form>
